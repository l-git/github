...
public class HtmlToWord {
    ...
    public void htmlToWord2() throws Exception {
        InputStream bodyIs = new FileInputStream("E:\\pd\\3.html");
        ...
        int i;
        InputStream inputStream=new FileInputStream(new File("e:/pd/3.css"));
        ...
        OutputStream outputStream=new FileOutputStream(new File("e:/pd/3.txt"));
       ...
       /* String content = "<html><head><style>" + css + "</style></head><body>" + body + "</body></html>";*/
        ...
        OutputStream os = new FileOutputStream("E:\\pd\\3.doc");
